...
public class TestReceipt {
    ...
    public void testAddMultipleProductsWithDiscount(){
        Product p = new Product(1, new BigDecimal(10), "product 1", "typ 2");
        Discount dd = new Discount(new BigDecimal(0.2), p);
        p.price = dd.getPriceWithDiscount();
        r.addProduct(p);
        Product p1 = new Product(2, new BigDecimal(20), "product 1", "typ 2");
        Discount d2 = new Discount(new BigDecimal(0.5), p1);
        p1.price = d2.getPriceWithDiscount();
        r.addProduct(p1);
